...
const products = [
  { id: 1, src: 'Noodles.jpg', title: 'Noodles' },
  { id: 2, src: 'Kraft_Dinners.jpg', title: 'Kraft' },
  { id: 3, src: 'Macaroni.jpg', title: 'Macaroni' },
  { id: 4, src: 'Quaker.jpg', title: 'Quaker' }
];
...
function showProducts() {
  ...
  for (var i = 0; i < products.length; i++) {
    ...
    text.innerHTML = "Name:" + products[i].title ;
